...
local spec = {
    ...
    { "<leader>G", "<cmd>Telescope grep_string theme=ivy<cr>", desc = "Grep String", nowait = true, remap = false },
    { "<leader>P", "<cmd>lua require('telescope').extensions.projects.projects()<cr>", desc = "Projects", nowait = true, remap = false },
    { "<leader>Q", "<cmd>Telescope quickfix theme=ivy<cr>", desc = "Resume", nowait = true, remap = false },
    { "<leader>R", "<cmd>Telescope resume theme=ivy<cr>", desc = "Resume", nowait = true, remap = false },
    ...
    { "<leader>d", "<cmd>Telescope diagnostics<cr>", desc = "Document Diagnostics", nowait = true, remap = false },
    ...
    { "<leader>gd", "<cmd>lua require('gitsigns').diffthis('HEAD', { vertical = true } )<CR>", desc = "Diff", nowait = true, remap = false },
